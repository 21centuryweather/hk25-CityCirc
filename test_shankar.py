🌍 Reanalysis Datasets (observationally constrained)
...
MERRA2: NASA’s Modern-Era Retrospective Analysis for Research and Applications, Version 2.

🧪 Experimental or Case-Specific Model Runs
...
☁️ UK Met Office Unified Model (UM) Configurations
